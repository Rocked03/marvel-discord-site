...
export const galleryEntries: GalleryEntry[] = [
  {
    title: "Marvel Discord 2017-2025",
    description:
      "Base branding for the Marvel Discord server between 2017 to 2025.",
    imageUrls: [
  ...
  {
    title: "Marvel Discord 2025",
    description: "Base branding for the Marvel Discord server from 2025.",
    imageUrls: [
      "/img/gallery/banner/Marvel Discord Banner.png",
      "/img/gallery/logo/Marvel Discord Logo.png",
